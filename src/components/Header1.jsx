          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                {/* <Link className="text-white text-5xl mr-3">
                  <BiSolidUserCircle/>
                  <ThemeToggler />
                </Link> */}
                ...
                <div className="mr-6">                                                    
                  ...
                  >
                    <p className="text-sm text-lg text-white font-bold mr-2">
                      ({credits}) credits
                    </p>
                ...
                to="/login"
                className="hidden py-2 px-2 ml-2 mr-3 text-base font-bold text-white hover:opacity-70 dark:text-white md:block"
              >
                Sign In
              </Link>
